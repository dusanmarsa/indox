...
export type AdapterKind = "github"; // | "confluence" — coming next
...
export type AdapterScope = GithubScope; // union grows as kinds are added
...
export type SourceMetadata = GithubSourceMetadata;
